...
public final class LoginClientConfiguration {
   ...
   * @return 客户端登录状态管理器
   */
  public static LoginTokenManager manager() {
   ...
   */
  public static void manager(LoginTokenManager manager) {
    config.setManager(manager);
  }

  private LoginTokenManager getManager() {
    return manager;
  }

  private void setManager(LoginTokenManager manager) {
