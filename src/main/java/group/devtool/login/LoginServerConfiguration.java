...
public class LoginServerConfiguration {
   ...
   * @return 登录凭证管理器
   */
  public static LoginTicketManager manager() {
   ...
   */
  public static void manager(LoginTicketManager manager) {
    config.setManager(manager);
  }

  private LoginTicketManager getManager() {
    return manager;
  }

  private void setManager(LoginTicketManager manager) {
